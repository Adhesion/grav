...
void gravManager::perimeterArrange( float boundL, float boundR, float boundU,
                                    float boundD )
{
    ...
    std::vector<RectangleBase*>* objects = drawnObjects;
...
bool gravManager::gridArrange( float boundL, float boundR, float boundU,
